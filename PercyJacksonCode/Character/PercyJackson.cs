...
public class PercyJackson : PlaceholderCharacterModel
{
    public const string CharacterId = "PercyJackson";
    ...
    public override RelicPoolModel RelicPool => ModelDb.RelicPool<PercyJacksonRelicPool>();
    public override PotionPoolModel PotionPool => ModelDb.PotionPool<PercyJacksonPotionPool>();
